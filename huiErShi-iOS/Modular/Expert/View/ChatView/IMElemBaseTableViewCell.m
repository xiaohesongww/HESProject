...
#import "IMElemBaseTableViewCell.h"

@implementation IMElemBaseTableViewCell
...
- (void)refreshCell:(MsgModel *)model
{
    ...
    if (!model.isRight)
    {
        ...
        image = [UIImage imageNamed:@"Msg_from"];
    ...
    else // 模拟右边
    {
        ...
        image = [UIImage imageNamed:@"Msg_to"];
