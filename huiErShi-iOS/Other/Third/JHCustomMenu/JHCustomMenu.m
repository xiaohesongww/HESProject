...
- (void)dismissWithCompletion:(void (^)(JHCustomMenu *object))completion
{
    ...
    [UIView animateWithDuration:0.2 animations:^{
        weakSelf.alpha = 0;
        weakSelf.tableView.frame = CGRectMake( kScreenWidth - LeftToView * 2.5, weakSelf.origin.y + TopToView, 0, 0);
...
//    [colors[serie] setFill];
    ...
    CGContextMoveToPoint(context,
                        kScreenWidth - LeftToView * 2.5, TopToView * 0.5);//设置起点
    
    CGContextAddLineToPoint(context,
                           kScreenWidth - LeftToView * 2, TopToView);
    
    CGContextAddLineToPoint(context,
                            kScreenWidth - LeftToView * 3, TopToView);
