...
static NSInteger const lz_pickerHeight = 300;
...
- (void)commitButtonClick:(UIButton *)button {
    ...
    if (self._selectBlock) {
        ...
        NSString *address = [NSString stringWithFormat:@"%@-%@",__currentArea.province,__currentArea.city];
        self._selectBlock(address,__currentArea.province,__currentArea.city);
    }
...
- (CGFloat)pickerView:(UIPickerView *)pickerView widthForComponent:(NSInteger)component {
    ...
    CGFloat width = lz_screenWidth/2.0;
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component  {
    ...
    if (__selectBlock && self.autoChange) {
        ...
        NSString *address = [NSString stringWithFormat:@"%@-%@",__currentArea.province,__currentArea.city];
        __selectBlock(address,__currentArea.province,__currentArea.city);
    }
}
